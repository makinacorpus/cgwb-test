...
from test.jpcw.testing import (
    PLONE_MANAGER_NAME,
    TEST_USER_NAME,
    TEST_JPCW_SIMPLE as SIMPLE,
    TEST_JPCW_FIXTURE as UNIT_TESTING,
    TEST_JPCW_INTEGRATION_TESTING as INTEGRATION_TESTING,
    TEST_JPCW_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING,
    TEST_JPCW_SELENIUM_TESTING as SELENIUM_TESTING,
)
