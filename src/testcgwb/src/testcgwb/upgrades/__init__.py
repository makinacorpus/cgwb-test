...
def upgrade_1000(context):
    ...
    #portal_setup.runImportStepFromProfile(
    #    'profile-testcgwb:default', 'jsregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-testcgwb:default', 'cssregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-testcgwb:default', 'portlets', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-testcgwb:default', 'propertiestool', run_dependencies=False)
    log('v1000 applied')
