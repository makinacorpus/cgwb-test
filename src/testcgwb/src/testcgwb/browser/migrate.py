...
from testcgwb.setuphandlers import setup_catalog
from testcgwb import upgrades
...
class Testcgwb_migrate(grok.View):
    ...
    def migrate_fileTestcgwb_to_blob(self):
        ...
        walker = CustomQueryWalker(self.context, FileTestcgwbMigrator, full_transaction=True)
        walker.go()
        upgrades.commit(self.context)
    ...
    def log_files(self, idx='1'):
        ptypes = ['Image', 'FileTestcgwb', 'File',
